...
class Tooltip extends Component {
    ...
    _addEventListener(obj, ev, fn) {
        obj.addEventListener ? obj.addEventListener(ev, fn, false) : obj.attachEvent('on' + ev, fn)
    }
    _removeEventListener(obj, ev, fn) {
    ...
    _createElement() {
        ...
        this.componentEl = node.childNodes[0] === 1 ? node.childNodes[0] : node
    ...
    _setTooltipPosition(windowWidth, e) {
        ...
        switch (position) {
            ...
            case 'right':
                ...
                if (tooltipWidth) setTooltipWidth('right', tooltipLeft)
