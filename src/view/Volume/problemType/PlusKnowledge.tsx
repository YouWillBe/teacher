            ...
            <ButtonWrap>
                ...
                {isShowKnowledge && (
                    <Dialog title='添加知识点' options={optionDialog} onClickClose={handleClickClose}>
                        <LoreListWrap>
                            <Left>
                                {volumeStore.loreList.loreList.map((item, index) => (
                                    <LoreListName
                                        key={item.id}
                                        isLoreListId={volumeStore.loreList.checkedId === item.id}
                            ...
                            <Center>
                                {volumeStore.loreList.lore.map((item, index) => (
                                                ...
                                                {item.children ? (
                                                    item.children.map(t => (
                                                        <Span
                                                            ...
                                                            setStyle={volumeStore.loreListId.includes(t.id)}
                                                        >
                                                            {t.name}
                                                        </Span>
                                                    ))
                                ...
                                <LoreList>
                                    {volumeStore.volumeProblem.loreList.map((item, index) => (
                                        <LoreItem key={item.id}>
                                            ...
                                            <FontWrap1 onClick={() => handleClickDeletLore(index)}>
