...
const NumberWrap: FC = props => {
    ...
    const handleClickTypeNumber = (data: IProblems) => {
        ...
        courseIndexStore.getTestProblem({
            id: (courseIndexStore.volumeDTO as any)[courseIndexStore.currentProblemDetailData.type][data.number - 1].id,
            testId: courseIndexStore.volumeDTO.id,
        })
