...
const Section: FC = props => {
    ...
    const handleClickLink = ({ location }: LocationContext) => {
        navigate(`${location.pathname}/analysis/${coursePreviewStore.doPreviewInfo!.testId}`)
    }
                ...
                <Left>
                    <StudentList
                        data={{
                            ...
                            Color: '#ef6666',
                            url: '',
                            studentList: coursePreviewStore.unfinishedStudentList,
                        }}
                    ></StudentList>
                    <StudentList
                        data={{
                            ...
                            Color: '#4CDF78',
                            url: '',
                            studentList: coursePreviewStore.finishedStudentList,
                        }}
                    ></StudentList>
                </Left>
                <Right>
