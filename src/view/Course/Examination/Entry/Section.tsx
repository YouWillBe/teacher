...
const Section: FC = () => {
    ...
    const handleClickLink = ({ location }: LocationContext) => {
        navigate(`${location.pathname}/analysis/${courseExaminationStore.doExaminationInfo!.testId}`)
    }
                ...
                <Left>
                    <StudentList
                        data={{
                            ...
                            Color: '#ef6666',
                            url: '',
                            studentList: courseExaminationStore.unfinishedStudentList,
                        }}
                    />
                    <StudentList
                        data={{
                            ...
                            Color: '#4CDF78',
                            url: '',
                            studentList: courseExaminationStore.finishedStudentList,
                        }}
                    />
                </Left>
                <Right>
